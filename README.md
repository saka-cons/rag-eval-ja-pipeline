...
[RAG Eval JA Repro 再現用評価データセット](https://huggingface.co/datasets/SakataConsul/rag-eval-ja-repro)を [Dify + LM Studio で評価するためのパイプライン](https://qiita.com/sakata_ai)です。
